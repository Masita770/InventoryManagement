...
//    ItemsService itemsService;
    ...
    void 全件一覧取得できるか検証() {
        ...
        Assertions.assertThat(itemsList).hasSize(3).contains(
                ...
                new Items(1, "机", "オフィスデスク", "2025-03-04 21:09:55", "0000-00-00 00:00:00"),
                new Items(2, "机", "キッチンテーブル", "2025-03-04 21:10:36", "0000-00-00 00:00:00"),
                new Items(3, "机", "ゲーミングデスク", "2025-03-04 21:11:08", "0000-00-00 00:00:00")
